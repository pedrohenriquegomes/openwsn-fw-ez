   ...
   switch (addr) {
      case 0x6ce6:
         switch(timeslot_offset) {
            case 0:
               ...
               extScheduleEntry->channelMask = 257;   // 0b0000000100000001
      ...
      case 0x50f4:
         switch(timeslot_offset) {
            ...
            case 14:
               extScheduleEntry->type = CELLTYPE_RX;
               extScheduleEntry->channelMask = 16448;   // 0b0100000001000000
      ...
      case 0xcf11:
         switch(timeslot_offset) {
            ...
            case 13:
               extScheduleEntry->type = CELLTYPE_RX;
               extScheduleEntry->channelMask = 10248;   // 0b0010100000001000
      ...
      case 0x6300:
         switch(timeslot_offset) {
            ...
            case 11:
               extScheduleEntry->type = CELLTYPE_RX;
               extScheduleEntry->channelMask = 2056;   // 0b0000100000001000
      ...
      case 0x79b6:
         switch(timeslot_offset) {
            ...
            case 10:
               extScheduleEntry->type = CELLTYPE_RX;
               extScheduleEntry->channelMask = 4112;   // 0b0001000000010000
      ...
      case 0x62b9:
         switch(timeslot_offset) {
            ...
            case 9:
               extScheduleEntry->type = CELLTYPE_RX;
               extScheduleEntry->channelMask = 11276;   // 0b0010110000001100
      ...
      case 0x5517:
         switch(timeslot_offset) {
            ...
            case 14:
               extScheduleEntry->type = CELLTYPE_RX;
               extScheduleEntry->channelMask = 32912;   // 0b1000000010010000
      ...
      case 0x52c3:
         switch(timeslot_offset) {
            ...
            case 19:
               extScheduleEntry->type = CELLTYPE_RX;
               extScheduleEntry->channelMask = 5124;   // 0b0001010000000100
      ...
      case 0x76e7:
         switch(timeslot_offset) {
            ...
            case 24:
               extScheduleEntry->type = CELLTYPE_RX;
               extScheduleEntry->channelMask = 514;   // 0b0000001000000010
      ...
      case 0xcdeb:
         switch(timeslot_offset) {
            ...
            case 17:
               extScheduleEntry->type = CELLTYPE_RX;
               extScheduleEntry->channelMask = 1028;   // 0b0000010000000100
      ...
      case 0x4d6a:
         switch(timeslot_offset) {
            ...
            case 33:
               extScheduleEntry->type = CELLTYPE_RX;
               extScheduleEntry->channelMask = 32896;   // 0b1000000010000000
      ...
      case 0x4527:
         switch(timeslot_offset) {
            ...
            case 27:
               extScheduleEntry->type = CELLTYPE_RX;
               extScheduleEntry->channelMask = 8224;   // 0b0010000000100000
      ...
      case 0x44ea:
         switch(timeslot_offset) {
            ...
            case 24:
               extScheduleEntry->type = CELLTYPE_RX;
               extScheduleEntry->channelMask = 32785;   // 0b1000000000010001
      ...
      case 0x510e:
         switch(timeslot_offset) {
            case 35:
               extScheduleEntry->type = CELLTYPE_TX;
               extScheduleEntry->channelMask = 1;   // 0b0000000000000001
               extScheduleEntry->neighbor = 0x7f43;
               return;
            default:
               break;
      ...
      case 0xb6c8:
         switch(timeslot_offset) {
            case 34:
               extScheduleEntry->type = CELLTYPE_TX;
               extScheduleEntry->channelMask = 256;   // 0b0000000100000000
               extScheduleEntry->neighbor = 0x117a;
               return;
            default:
               break;
      ...
      case 0x5966:
         switch(timeslot_offset) {
            case 30:
               extScheduleEntry->type = CELLTYPE_TX;
               extScheduleEntry->channelMask = 288;   // 0b0000000100100000
               extScheduleEntry->neighbor = 0x4d35;
               return;
            default:
               break;
      ...
      case 0x6fb1:
         switch(timeslot_offset) {
            case 28:
               extScheduleEntry->type = CELLTYPE_TX;
               extScheduleEntry->channelMask = 384;   // 0b0000000110000000
               extScheduleEntry->neighbor = 0xea5d;
               return;
            default:
               break;
