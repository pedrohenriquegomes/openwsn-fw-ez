   ...
   switch (addr) {
      ...
      case 0x79b6:
         switch(timeslot_offset) {
            ...
            case 10:
               extScheduleEntry->type = CELLTYPE_RX;
               extScheduleEntry->channelMask = 10352;   // 0b0010100001110000
      ...
      case 0x62b9:
         switch(timeslot_offset) {
            ...
            case 9:
               extScheduleEntry->type = CELLTYPE_RX;
               extScheduleEntry->channelMask = 4618;   // 0b0001001000001010
      ...
      case 0x4527:
         switch(timeslot_offset) {
            ...
            case 24:
               extScheduleEntry->type = CELLTYPE_RX;
               extScheduleEntry->channelMask = 34052;   // 0b1000010100000100
      ...
      case 0x44ea:
         switch(timeslot_offset) {
            ...
            case 29:
               extScheduleEntry->type = CELLTYPE_RX;
               extScheduleEntry->channelMask = 8384;   // 0b0010000011000000
      ...
      case 0x510e:
         switch(timeslot_offset) {
            case 35:
               extScheduleEntry->type = CELLTYPE_TX;
               extScheduleEntry->channelMask = 20513;   // 0b0101000000100001
               extScheduleEntry->neighbor = 0x7f43;
               return;
            default:
               break;
